...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, required=True, choices=['GLMModel', 'OpenAIModel', 'Azure'],
                                 help='The type of translation model to use. Choose in[ "GLMModel" 、"OpenAIModel"、 "Azure"].')
    ...
    def parse_arguments(self):
        ...
        # if args.model_type == 'OpenAIModel' or args.model_type == 'Azure':
